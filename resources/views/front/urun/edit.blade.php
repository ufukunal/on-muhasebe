                        ...
                        <form action="{{route('urun.update', ['id' => $data[0]['id']])}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row firma--area">
                                <div class="col-md-12">
                                    ...
                                    <input class="form-control" required name="urunAdi" placeholder="Ürün Adı Giriniz" id="l0"  type="text" value="{{$data[0]['urunAdi']}}">
                                </div>
                                <div class="col-md-12">
                            ...
                            <div class="form-group row">
                                <div class="col-md-6">
                                    ...
                                    <input type="text" class="form-control" name="alisFiyati" value="{{$data[0]['alisFiyati']}}">
                                </div>
                                <div class="col-md-6">
                                    <label class="col-form-label" for="satisFiyati">Satış Fiyatı</label>
                                    <input type="text" class="form-control" name="satisFiyati" value="{{$data[0]['satisFiyati']}}">
                                </div>
                            </div>
