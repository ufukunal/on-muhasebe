            ...
            <div class="col-md-12 widget-holder">
                <div class="widget-bg">
                    <div class="widget-body clearfix">
                        <form action="{{ route('fatura.update', ['id' => $data[0]['id']]) }}" method="POST" enctype="multipart/form-data">
                            @csrf

                            <div class="form-group row firma--area">
                                <div class="col-md-4">
                                    <label class="col-form-label" for="l0">Fatura No</label>
                                    <input class="form-control" required name="faturaNo" placeholder="Fatura No Giriniz" id="l0"  type="text" value="{{$data[0]['faturaNo']}}">
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" required name="faturaTarih" placeholder="Fatura Tarihi Giriniz" id="l0" type="date" value="{{ $data[0]['faturaTarih'] }}">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12">
                                                    ...
                                                    <td>
                                                        <select class="form-control kalem" name="islem[{{ $k }}][kalemId]">
                                                            ...
                                                            @foreach(\App\Kalem::getList(0) as $key => $value)
                                                                <option @if($value['id'] == $v['kalemId']) selected @endif data-k="{{$value['kdv']}}" value="{{$value['id']}}">{{$value['ad']}}</option>
                                                            @endforeach
                                                        </select>
                                                    </td>
                                                    <td>
                                                        <select class="form-control urun" name="islem[{{ $k }}][urunId]">
                                                            ...
                                                            @foreach(\App\Urun::all() as $key => $value)
                                                                <option @if($value['id'] == $v['urunId']) selected @endif data-fiyat="{{$value['satisFiyati']}}" value="{{$value['id']}}">{{$value['urunAdi']}}</option>
                                                            @endforeach
                                                        </select>
                                                    </td>
