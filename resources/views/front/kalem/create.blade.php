                        ...
                        <form action="{{route('kalem.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row">
                                <div class="col-md-12">
                                    ...
                                    <div>
                                        <input type="radio" checked class="change-customerType" name="kalemTipi" value="0"> Gelir
                                    </div>
                                    <div>
                                        <input type="radio" class="change-customerType" name="kalemTipi" value="1"> Gider
                                    </div>
                                </div>
                            </div>
                            <div class="form-group row firma--area">
                                <div class="col-md-6">
                                    ...
                                    <input class="form-control" required name="ad" placeholder="Adı Giriniz" id="l0"  type="text">
                                </div>
                                <div class="col-md-6">
                                    <label class="col-form-label" for="l0">Kdv</label>
                                    <input class="form-control" required name="kdv" value="18" id="l0" placeholder="Kdv Giriniz" type="text">
                                </div>
                            </div>
