                        ...
                        <form action="{{route('banka.store')}}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group row firma--area">
                                <div class="col-md-4">
                                    ...
                                    <input class="form-control" required name="ad" placeholder="Banka Adı Giriniz" id="l0"  type="text">
                                </div>
                                <div class="col-md-4">
                                    <label class="col-form-label" for="l0">Banka İban</label>
                                    <input class="form-control" required name="iban"  id="l0" placeholder="Banka İban Giriniz" type="text">
                                </div>
                                <div class="col-md-4">
                                    <label class="col-form-label" for="l0">Banka Hesap No</label>
                                    <input class="form-control" required name="hesapNo" id="l0" placeholder="Banka Hesap No Giriniz" type="text">
                                </div>
                            </div>
